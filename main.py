...
from prompts import (
    add_course_prompt,
    delete_course_prompt,
    view_all_courses_prompt,
    view_specific_courses_prompt,
    enroll_student_prompt,
    drop_student_prompt,
    create_assignment_prompt,
    submit_assignment_prompt,
    view_student_average_prompt,
    view_assignment_average_prompt,
    top_five_students_prompt,
    view_student_assignment_grade_prompt,
)
